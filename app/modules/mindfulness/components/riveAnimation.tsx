...
export default function RiveAnimation({
  ...
  // Clear text and reset animation on unmount
  useEffect(() => {
    return () => {
  ...
  useEffect(() => {
    ...
    try {
      // Set the text and play animation
      rive.setTextRunValue("user_input", textValue)
      rive.play()
  ...
  }, [rive, textValue, onAnimationComplete, resourceName, artboardName, stateMachineName])

  return (
    <View style={[styles.container, style]} accessibilityRole="image" accessibilityLabel="Animated cloud visualization">
      <RiveComponent style={{ width, height }} />
    </View>
  )
}
