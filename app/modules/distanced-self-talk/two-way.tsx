...
const TwoWayScreen: React.FC = () => {
  ...
  const handleNextPress = () => {
    router.push("/modules/distanced-self-talk/exercise");
  };
        ...
        >
          ...
          <View style={styles.content}>
            <ThemedText style={styles.heading}>
              The two ways of applying self Distanced Talk
            </ThemedText>

            <ThemedText style={styles.description}>
              1. Visual self-distancing {"\n"}2. Linguistic self-distancing
            </ThemedText>
            ...
            <ThemedText style={styles.description}>
              ...
              {
                " involves mentally viewing situations from an outside perspective, while "
              }
              <ThemedText style={styles.boldText}>
                linguistic self-distancing
              </ThemedText>
              {
                " uses third-person language. Both methods create psychological distance, allowing for more objective analysis of your thoughts and emotions."
              }
            </ThemedText>
          </View>
        </ScrollView>
